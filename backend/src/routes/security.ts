    ...
    const mockVulnerabilities = [
      {
        ...
        version: '1.1.1t',
        fixedVersion: '1.1.1u',
        clusterId: { name: 'production-us-east-1' },
      ...
      },
      {
        ...
        severity: 'high',
        status: 'in-progress',
        description: 'Remote code execution in nginx ingress controller',
        package: 'nginx-ingress',
        version: '1.8.0',
        fixedVersion: '1.9.1',
        clusterId: { name: 'staging-eu-west-1' },
